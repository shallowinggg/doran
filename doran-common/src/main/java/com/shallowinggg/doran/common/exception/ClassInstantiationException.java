...
public class ClassInstantiationException extends RuntimeException {
     ...
     */
    public ClassInstantiationException(Class<?> beanClass, String msg, @Nullable Throwable cause) {
     ...
     * @since 4.3
     */
    public ClassInstantiationException(Constructor<?> constructor, String msg, @Nullable Throwable cause) {
